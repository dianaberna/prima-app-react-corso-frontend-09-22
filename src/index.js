...
root.render(
  <React.StrictMode>
    ...
    <details>
      <summary>
        Mostra componente Layout (per importazioni immagini vedere componente
        Header)
      </summary>
      <Layout />
    </details>
    ...
    <h2>
      Button & ButtonWithLoader (concetti: props, render condizionato,
      PropTypes, setState)
    </h2>
    <details>
    ...
    <h2>Routing</h2>
    <a href="https://github.com/dianaberna/shop-corso-frontend">
      Visita repo Shop
    </a>
  </React.StrictMode>
)
